            ...
            <table class="data-table">
              ...
              <tbody>
                <tr v-for="library in libraries" :key="library.id">
                    ...
                    <td data-label="Nama Perpustakaan">{{ library.nama }}</td>
                    <td data-label="Nama Kepala">{{ library.kepalaPerpustakaan }}</td>
                    <td data-label="Tahun Berdiri">{{ library.tahunBerdiri }}</td>
                  <td>
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      if (libraryStore.libraries.length === 0) {
        const dummyData = [
          {
            id: 1,
            periode: '2024-1',
            nama: 'Perpustakaan Sejahtera',
            kepalaPerpustakaan: 'Budi Sumanto',
            tahunBerdiri: 2010
          },
          {
            id: 2,
        ...
        // Add each dummy data through store action to ensure it's saved to localStorage
        dummyData.forEach(data => libraryStore.addLibrary(data))
      }
